...
def add_args(parser):
    ...
    parser.add_argument('--num_layers', type=int, default=2,
                        help='GCN layer number.')
    parser.add_argument('--heads', type=int, default=2,
                        help='Self attention heads')
    parser.add_argument('--module_sequence_selector', type=int, default=1, choices=[0, 1],
                        help='Order used to select GCN modules and Transformer modules.')
    return parser